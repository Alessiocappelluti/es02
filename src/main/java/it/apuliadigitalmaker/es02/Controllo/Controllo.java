package it.apuliadigitalmaker.es02.Controllo;

import it.apuliadigitalmaker.es02.BService.BookService;
...
public class Controllo {
    ...
    @Autowired
    public void HomeController(BookService bookService){
        this.bookService = bookService;
    }

    public Controllo(BookService bookService) {
        this.bookService = bookService;
    }
    ...
    public String foobarPost(
        ...
        ra.addFlashAttribute("formsook", formbook);
